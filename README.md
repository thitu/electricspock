...
The latest version of this fork is `1.0.3` which has been updated to support [Robolectric](http://robolectric.org) version `4.0.2`
...
```groovy
dependencies {
  testImplementation "com.github.thitu.electricspock:electricspock:1.0.3"
}
```
