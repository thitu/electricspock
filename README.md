...
The latest version of this fork is `4.3.1-2` which has been updated to support [Robolectric](http://robolectric.org) version `4.3.1`
...
```groovy
dependencies {
  testImplementation "com.github.thitu.electricspock:electricspock:4.3.1-2"
}
```
